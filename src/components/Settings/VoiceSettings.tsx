...
import { Volume2, Mic, Settings, Play, Square, Brain, Zap } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-600 mb-3">
                Test speech recognition by clicking the button below and speaking into your microphone.
              </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="space-y-1 text-sm text-blue-700">
                ...
                <div>✓ Safari: Partial support</div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  geminiService.updateConfig({ apiKey: e.target.value });
                }}
              ...
              <p className="text-xs text-gray-500 mt-1">
                Using Gemini 2.5 Flash for advanced conversational AI
              </p>
            </div>
        ...
        <div className="border-t border-gray-200 pt-8">
          <h3 className="text-lg font-medium text-gray-900 mb-4">AI-Enhanced Voice Commands</h3>
          ...
          <div className="mt-4 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h4 className="font-medium text-purple-800">Powered by Gemini 2.5 Flash</h4>
            </div>
            <p className="text-sm text-purple-700">
              The system now uses Google's most advanced Gemini 2.5 Flash model for superior natural language understanding 
